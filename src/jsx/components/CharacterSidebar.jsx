...
function CharacterSidebar(props) {
  ...
  const GetCharacterPanels = (props) => {
    ...
    let characterImages = ImportAll(
      require.context("../../images/character_panels/small", false, /\.png$/)
    );
    ...
    return <section className="character-list">{returnHTML}</section>;
  };
  ...
  return (
    <section className="character-sidebar">
      ...
      <div
        className="show-character-sidebar"
        onClick={() => {
          ToggleSidebar();
        }}
      >
